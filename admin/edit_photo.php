...
// If the ID is empty - avoiding malicious software
if (empty($_GET['id'])) {
    ...
    if (isset($_POST['update'])) {
        ...
        if ($photo) {
            ...
            $photo->save(); // using the save method in the db_object
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-8">
                           ...
                           <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="" cols="38" rows="18"><?php echo $photo->description; ?></textarea>
